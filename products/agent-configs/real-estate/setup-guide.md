# Real Estate Agent AI — Setup Guide

This guide walks you through installing the Real Estate Agent AI Config Pack in three platforms: ChatGPT Custom GPT, Claude Projects, and Gemini Gems. Pick the platform that fits your workflow — or set it up on all three.
...
3. **Configure the GPT** — In the Builder, describe what you want in plain language:
   > "Build me a real estate assistant that helps buyers and sellers navigate the home buying and selling process. It should be professional, knowledgeable, and consultative."
...
7. **Configure Capabilities** — Disable capabilities you don't need (DALL-E, Code Interpreter, Browsing) unless your workflow requires them. For a real estate assistant, web browsing can be useful for checking current listings.
...
2. **Create a Project** — Click "Projects" in the sidebar → "Create Project." Name it something like "Real Estate AI Assistant."
...
6. **Customize Further** — Edit the project instructions anytime to add your brokerage name, local market focus, team contacts, or brand-specific language.
...
2. **Create a Gem** — Click "Gems" in the sidebar → "New Gem." Name it "Real Estate AI Assistant."
...
- **Add your brokerage name and branding** to the system prompt.
- **Include local market data** — median prices, popular neighborhoods, local regulations.
- **Add team member names and roles** so the AI can direct clients to the right person.
- **Include your specific processes** — how you handle showings, your CRM workflow, your preferred lenders and title companies.
- **Update the knowledge base** with your own Q&A pairs specific to your market.
